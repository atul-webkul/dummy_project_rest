...
<div id="cpm-progress-wrap">
    ...
    <ul class="cpm-activity dash">
    	...
    	if ( $activities ) {
            ...
            ?>
            <li><h2><?php _e( 'No Progress Found!', 'cpm-pro' ); ?></h2></li>
            <?php
        }
...
<?php if ( $count['approved'] > count( $activities ) ) { ?>
    <a href="#" <?php  cpm_data_attr( array( 'projects_id' => json_encode( $projects_id ), 'start' => count( $activities ), 'total' => $count['approved']) ); ?> class="button cpm-loads-more"><?php _e( 'Load More...', 'cpm-pro' ); ?></a>
<?php }
