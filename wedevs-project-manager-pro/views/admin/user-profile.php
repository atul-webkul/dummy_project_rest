...
<tr>
	<th>
		<label for="tc_location"><?php _e( 'Daily Digest', 'cpm-pro' ); ?></label>
	</th>
	<td>
		<label for="cpm_daily_digest_status">
			...
			<span class="description"><?php _e('Enable project manager Daily Digest', 'cpm-pro'); ?></span>
		</label>
	</td>
</tr>
...
<table class="form-table">
    <tr>
        <th><?php _e( 'Email Notification', 'cpm-pro' ); ?> </th>
        <td>
            <label for="cpm-email-notification">
                ...
                <span class="description"><?php _e( 'Enable project manager email', 'cpm-pro' ); ?></span></em>
            </label>
        </td>
    </tr>
</table>