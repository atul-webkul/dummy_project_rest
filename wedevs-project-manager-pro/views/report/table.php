            ...
            foreach ( $projects as $list_id => $lists ) {
                ...
                ?>
                    ...
                    <table class="widefat">
                        <thead>
                            <tr>
                                <th><?php _e( 'Task', 'cpm-pro' ); ?></th>
                                <th><?php _e( 'Assigned To', 'cpm-pro' ); ?></th>
                                <th><?php _e( 'Start Date', 'cpm-pro' ); ?></th>
                                <th><?php _e( 'Due Date', 'cpm-pro' ); ?></th>
                                <th><?php _e( 'Status', 'cpm-pro' ); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                <?php
                foreach ( $lists as $task_id => $tasks ) {
                    ...
                    <?php echo $task->post_title; ?>
                                    ...
                                    <td>
                                        <?php echo $task->completed ? __( 'Completed', 'cpm-pro' ) : __( 'Incompleted', 'cpm-pro' ); ?>
                                    </td>
                                </tr>
