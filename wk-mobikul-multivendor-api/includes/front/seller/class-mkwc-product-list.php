 ...
 * @author Webkul
 * @version 1.0.0
 * This file handles seller product list functions.
 */
...
if ( ! class_exists( 'Mkwc_Product_List' ) ) {
    /**
     *
     */
    class Mkwc_Product_List extends Includes\Mkwc_Authentication implements Util\Mkwc_Product_List_Interface
    {
        ...
        public function mkwc_get_product_list()
        {
            ...
            if ( $products ) {
                $data = array_merge( $data, array(
                    ...
                    'data_displayed' => count( $products['products'] ),
